...
export class ProductosService {
  ...
  constructor() {
    ...
    this.newProducts.push(new Product("blasphemous", "Blasphemous", "../assets/img/blasphemous.jpg", "Una terrible maldición conocida como el Milagro ha caído sobre la tierra de Cvstodia y sus habitantes. Eres el Penitente, el único superviviente de la masacre de la hermandad del Lamento Mudo. Estás atrapado en un ciclo de penitencia de muerte y resurrección constante, y solo tú puedes librar al mundo de este destino tan terrible y llegar al origen de tu angustia.", "aventura", 25.45, 15, "https://www.youtube.com/embed/seGW4vdfL7A?si=CaeazhCNM9QwbDOe"))
    this.newProducts.push(new Product("street-fighter-6", "Street Figther 6", "../assets/img/sf6.jpg", "¡Aquí llega el peso pesado de Capcom! Street Fighter™ 6 sale a la venta en todo el mundo el 2 de junio de 2023, y trae consigo una nueva evolución de la saga Street Fighter™. Street Fighter 6 hace gala de la potencia del RE ENGINE de Capcom, e incluye tres modos de juego: World Tour, Fighting Ground y Battle Hub.", "pelea", 13.45, 15, "https://www.youtube.com/embed/1INU3FOJsTw?si=RyNrGMlguRBUZjCO"))
    this.newProducts.push(new Product("lethal-company", "Lethal Company", "../assets/img/lethal.jpg", "Eres un trabajador contratado por la Empresa. Su trabajo consiste en recolectar chatarra de lunas industrializadas abandonadas para cumplir con la cuota de ganancias de la Compañía. Puedes usar el dinero que ganes para viajar a lunas nuevas con mayores riesgos y recompensas, o puedes comprar trajes elegantes y decoraciones para tu barco.", "terror", 25.45, 15, "https://www.youtube.com/embed/Su6OsTb1w9Q?si=9dfYoKajvxtVWlcr"))
